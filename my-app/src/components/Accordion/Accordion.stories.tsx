...
export const UserUncollapsedMode = () => <Accordion titleValue={"Users"} collapsed={true} onChange={callback}
                                                    items={[{title:'Ivan', value:1},{title:'Viktor', value:2},{title:'Dimych', value:3},
                                                        {title:'Artur', value:4}]} onClick={onClickCallback}/>

export const ModeChanging = () => {
    const [value, setValue] = useState<boolean>(true);
    return <Accordion titleValue={"Users"} collapsed={value} onChange={()=>setValue(!value)} items={[{title:'Ivan', value:1},{title:'Viktor', value:2},{title:'Dimych', value:3},
